...
const Dashboard = () => {
    const userAvatar = "https://i.imgur.com/ESwWy8v.png";
                    ...
                    {contacts.length > 0 ? (
                        <section className="worklist">
                            <div className="worklist-header">
                                ...
                                <h2 className="worklist-title">Дашборд</h2>
                            </div>
                ...
                selectedContact ? ( // Check if selectedContact exists
                    <section className={`chat-section ${animationClass}`}>
                        <div className="chat-info">
                            <div className="chat-info-img-container">
                                <img
                        ...
                        <div className="chat-body" ref={chatContainerRef}>
                            {chatMessages.length > 0 ? (
                                ...
                                <p>Пока что нет сообщений. Будьте первым, кто напишет!</p>
                            )}
                        </div>
                    ...
                    <div className="no-selected-contact">
                        <p>Пожалуйста выберите контакт.</p>
                    </div>
                )
            ) : (
                <section
